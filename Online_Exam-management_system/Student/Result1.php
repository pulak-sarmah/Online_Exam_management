                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form method="post" action="marks_insert.php" id="exam_form" class="form-horizontal row-fluid">
                                  ...
                                  <div class="module">
                                        <div class="module-head">
                                        <center><h3>Your Marks</h3></center>
                                        </div>
                                  <div class="module-body">
                                    <br />
									<form method="post" action="marks_insert.php" id="exam_form" class="form-horizontal row-fluid">
										...
										<p style="margin-top: 5px;">Your Answer : <?php echo $res[$k]; ?></p><br>
										<p style="margin-top: 5px;">Correct Answer : <?php echo $corr[$k]; ?></p><br>
										
                                            <p style="margin-top: 5px;">Your Marks:<?php echo $m;?> </p>
										...
										?>
										<p style="margin-top: 5px;">Your Total Marks:<?php echo $marks;?> </p>
										</div>
										</div>
										</form>
