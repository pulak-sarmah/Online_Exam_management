<?php
    ...
    if (isset($_GET['delete'])) {
        $sql = "DELETE FROM student WHERE s_id='{$_GET['s_id']}'";
        $dQuery = mysqli_query($conn,$sql);
        if ($dQuery) {
            header('Refresh:1; student_list.php');
        }
    }
                                        ...
                                        <tbody>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?php echo $row->student_password; ?></td>
                                                    <td><a href="student_list.php?delete=1&s_id=<?php echo $row->s_id; ?>" ><input class="btn btn-primary btn-small" value="DELETE" type="submit" name="delete"></a></td>
                                            </tr>
                                        </tbody>
                                        <?php
                                            }
